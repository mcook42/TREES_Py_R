...
def quad_Av_calc(gc0, Ca, Vcmax, Rd, Kc, Ko, O2, gammaStar):
    aa = -1.0/gc0
...
def quad_Aj_calc(gc0, Ca, gammaStar, J, Rd):
    aa = -4.0 / gc0
...
def J_calc(Ir, Jmax, phi_J, theta_J):
    Ji = Ir * phiJ
    aa = thetaJ
    bb = -Ji -Jmax
    cc = Ji*Jmax
